                ...
                <div class="col-lg-5 col-md-12">
                    <div class="products-details-image">
                        <ul class="products-details-image-slides">
                            <li><img src="{{ asset('product/relaxo-1.jpg') }}" alt="image"></li>
                    ...
                    <div class="products-details-desc">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>72"x30"x4"</td>
                                    <td>₹3333/- per piece</td>
                                </tr>
                                <tr>
                                    <td>72"x36"x4"</td>
                                    <td>₹3999/- per piece</td>
                                </tr>
                                <tr>
                                    <td>72"x48"x4"</td>
                                    <td>₹5333/- per piece</td>
                                </tr>
                                <tr>
                                    <td>72"x60"x4"</td>
                                    <td>₹6666/- per piece</td>
                                </tr>
                                <tr>
                                    <td>72"x72"x4"</td>
                                    <td>₹7999/- per piece</td>
                                </tr>
                            </tbody>
                        </table>
 ...
 --}}
                      ...
                      <a href="#" class="optional-btn"><i class='bx bx-refresh'></i> Add to Compare</a>
                        ...
                        <div class="buy-checkbox-btn">
                            ...
                            --}}
                            <div class="item">
                                <a href="#" class="default-btn">YES, I am interested !</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content">
                    <div class="tabs-item">
                        <div class="products-details-tab-content">
                            <p>Design inspiration lorem ipsum dolor sit amet, consectetuer adipiscing elit. Morbi commodo,
                                ...
                                fermentum bibendum enim nibh eget ipsum. Nam consectetuer. Sed aliquam, nunc eget euismod
                                ullamcorper, lectus nunc ullamcorper orci, fermentum bibendum enim nibh eget ipsum. Nulla
                                libero. Vivamus pharetra posuere sapien.</p>
                        ...
                        <div class="products-details-tab-content">
                            ...
                            <ol>
                                <li>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                    has been the industry's standard dummy text ever since the 1500s.</li>
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <input type="text" id="review-title" name="review-title"
                                                        placeholder="Enter your review a title" class="form-control">
                                                </div>
                                            </div>

                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <textarea name="review-body" id="review-body" cols="30" rows="6" placeholder="Write your comments here"
                ...
                <div class="products-slides owl-carousel owl-theme">
                    <div class="single-products-box">
                        ...
                        <div class="products-content">
                            <h3><a href="#">Relaxo Ortho [M-001A]</a></h3>
                            <div class="price">
