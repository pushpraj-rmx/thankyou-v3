  ...
  <section class="terms-conditions-area ptb-100">
    <div class="container">
        <div class="section-title">
            {{-- <span class="sub-title">Terms and Conditions</span> --}}
        ...
        <div class="terms-content">
            ...
            <p>All payments must be made in full before shipping. We accept various modes of payment including credit cards, debit cards, and net banking. The customer agrees to provide current, complete, and accurate billing and shipping information. In case of any discrepancies or issues, we will notify you to confirm the changes.</p>

            <h4>4. Product Availability</h4>
            <p>All orders are subject to product availability. In the event a product is not available, we will notify you as soon as possible and offer alternatives or a full refund.</p>

            <h4>5. Shipping and Delivery</h4>
            <p>We strive to process and dispatch orders within the stated time frame, but delays may occur due to external factors such as courier delays, strikes, or natural disasters. We do not guarantee delivery times and are not liable for any delay in receiving your order. In case of significant delays, we will notify you promptly.</p>

            <h4>6. Cancellation Policy</h4>
            <p>Orders may be cancelled within 24 hours of placement without any penalty. After this period, cancellation requests may not be accepted if the order is already processed. In case of cancellation after dispatch, return shipping charges may apply.</p>
            ...
            <p>These terms are governed by the laws of India. Any disputes arising out of or in connection with these terms or the use of our products shall be resolved exclusively in the courts of New Delhi, India.</p>

            <h4>13. Changes to Terms and Conditions</h4>
            <p>We reserve the right to update or modify these terms at any time without prior notice. It is your responsibility to review the terms regularly to ensure your compliance. Your continued use of the website constitutes acceptance of any changes made to these terms.</p>
