                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item megamenu"><a href="#" class="nav-link active">Pages <i
                                        class='bx bx-chevron-down'></i></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <div class="container">
                                                    ...
                                                    <ul class="megamenu-submenu">
                                                        <li>
                                                            <div class="aside-trending-products">
                                                                <img src="assets/img/categories/img1.jpg"
                                                                    alt="image">
                                                            ...
                                                            <div class="aside-trending-products">
                                                                <img src="assets/img/categories/img2.jpg"
                                                                    alt="image">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        ...
                        <div class="features-text">
                            <h5><i class="bx bx-planet"></i>Customized solutions for customers of all ages</h5>
                    ...
                    <div class="sidebar-about-content">
                        ...
                        <div class="about-the-store">
                            ...
                            <ul class="sidebar-contact-info">
                                <li><i class='bx bx-map'></i> <a href="#" target="_blank">Wonder Street, USA,
                                        New York</a></li>
                    ...
                    <div class="woocommerce-widget-area">
                        ...
                        <div class="woocommerce-widget color-list-widget">
                            ...
                            <ul class="color-list-row">
                                <li class="active"><a href="#" title="Black" class="color-black"></a>
                                </li>
                        ...
                        <div class="about-the-store">
                            ...
                            <ul class="footer-contact-info">
                                ...
                                <li><i class='bx bx-envelope'></i> <a
                                        href="mailto:hello@xton.com">hello@xton.com</a></li>
                            </ul>
                        </div>
